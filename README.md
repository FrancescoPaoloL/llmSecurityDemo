...
[![Tests](https://img.shields.io/badge/tests-43%2F44%20passing-brightgreen)]()
[![Categories](https://img.shields.io/badge/OWASP%20categories-6%2F10-blue)]()
...
**Detection accuracy**: 97.3% on test suite (43/44 tests passing) — see [tests/TESTING.md](tests/TESTING.md)
...
**Overall: 6/10 categories implemented | 43/44 tests passing (97.7%)**
...
- **97.7% accuracy** with 1 known false positive (LLM01: "ignore spam emails")
- **English only**
